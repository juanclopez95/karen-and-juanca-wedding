  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "KOVA", price: "$$", mapsUrl: "https://maps.app.goo.gl/VdqJFc58wKgGU5s46", eta: "8 min", rsvpUrl: "#", ig: "kovaclub____", desc: "An immersive nightlife experience in Miraflores where architecture, light and sound collide." },
  ...
  const categoriesEs = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "KOVA", price: "$$", mapsUrl: "https://maps.app.goo.gl/VdqJFc58wKgGU5s46", eta: "8 min", rsvpUrl: "#", ig: "kovaclub____", desc: "Una experiencia nocturna inmersiva en Miraflores donde la arquitectura, la luz y el sonido se fusionan." },
