...
export default function Home() {
  const acts = [
    ...
    },
    {
      ...
      description: <>{'After our Vow, we\'ll take a ride to the outskirts of Lima, Mamacona. The venue is located in the sanctuary of the famous Caballo Peruano de Paso.\n\nMusic is our love language, so this celebration is decorated by the sound that shaped our time together. \n\n& perhaps, the rhythm deepens.\n\nShuttles return at 11:00 PM and 1:00 AM, with a final bus at 3:45 AM back to the '}<a href="https://www.google.com/maps/place/InterContinental+Lima,+an+IHG+Hotel" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-60 transition-opacity">Intercontinental Hotel Miraflores</a>.</>
    }
  ];
