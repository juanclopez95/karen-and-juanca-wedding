...
export default function Colombia() {
  const acts = [
    ...
    },
    {
      ...
      description: "Nos reunimos para una promesa sagrada. Un momento de calma antes de la tormenta. Un espacio sagrado donde nos comprometemos al ritmo que hemos construido juntos."
    },
    {
      ...
      description: "Tras nuestros votos, nos trasladamos a las afueras de Lima, Mamacona.\n\nEl local se encuentra en un santuario del famoso Caballo Peruano de Paso.\n\nEn nuestras primeras conversaciones, descubrimos que la música era nuestro lenguaje del amor. Esta celebración está decorada por el sonido que marcó nuestro tiempo juntos.\n\n& quizás, el ritmo se profundiza."
    }
  ];
